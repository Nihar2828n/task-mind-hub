...
export default function Scheduler() {
  const { todayTasks, addTask, tasks } = useApp();
      ...
      {!showForm && (
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Smart scheduling finds the best time</p>
          </div>
        </motion.button>
      )}
        ...
        {showForm && (
          ...
          >
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full bg-muted rounded-xl px-4 py-2.5 text-sm text-foreground outline-none focus:ring-2 focus:ring-primary/30"
                />
              </div>
              <div className="flex-1">
                <label className="text-xs text-muted-foreground mb-1.5 flex items-center gap-1">
            ...
            <textarea
              ...
              rows={2}
              className="w-full bg-muted rounded-xl px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/30 resize-none"
            />
