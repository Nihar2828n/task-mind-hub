...
import { User, Palette, Moon, Sun, Clock, Target, Trash2 } from 'lucide-react';
...
export default function SettingsPage() {
  const { settings, updateSettings, setTasks } = useApp();
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              onChange={(e) => updateSettings({ pomodoroWork: Number(e.target.value) || 25 })}
              className="w-full bg-muted rounded-xl px-3 py-2 text-sm text-foreground outline-none mt-1"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => updateSettings({ pomodoroBreak: Number(e.target.value) || 5 })}
              className="w-full bg-muted rounded-xl px-3 py-2 text-sm text-foreground outline-none mt-1"
            />
          </div>
        </div>
